function ProjectDemoTest_MilestoneToRepo_Add{
    ...
    $result = Add-MilesonesToRepo -Repo testproject-repo-apendix -Title "ML1 title" -WhatIf @InfoParameters
    ...
    $result = Add-MilesonesToRepo -Repo testproject-repo-apendix -Title "ML2 title" -WhatIf -Description "Description for ML 2" @InfoParameters
    ...
    $result = Add-MilesonesToRepo -Repo testproject-repo-apendix -Title "ML3 title" -WhatIf -Date (Get-Date).AddDays(14) @InfoParameters
