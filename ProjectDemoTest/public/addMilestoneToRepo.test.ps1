function ProjectDemoTest_MilestoneToRepo_Add{
    ...
    Assert-contains -Presented $infovar.MessageData -Expected 'gh api repos/OctoDemo/testproject-repo-apendix/milestones -X POST -f title="ML1 title"'
    ...
    Assert-IsNull $result
    Assert-Contains -Presented $infovar.MessageData -Expected 'gh api repos/OctoDemo/testproject-repo-apendix/milestones -X POST -f title="ML2 title" -f description="Description for ML 2"'
    ...
    $expectedString = 'gh api repos/OctoDemo/testproject-repo-apendix/milestones -X POST -f title="ML3 title" -f due_on="{date}"' -replace "{date}", $datestring
