...
function ProjectDemoTest_GetPublicString{ 
...
function ProjectDemoTest_GetPrivateString {

    $testedModulePath =  $TESTED_MODULE_PATH | Join-Path -ChildPath "ProjectDemo.psd1"
...
Export-ModuleMember -Function ProjectDemoTest_*
